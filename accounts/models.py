...
def create_or_update_user_profile(sender, instance, created, **kwargs):
    if created:
        # Create a profile with a default picture on user creation
        UserProfile.objects.create(user=instance, profile_picture='default/default-user.png')
    else:
        # Ensure a profile exists for existing users as well
        ...
        # Save in case other fields on the related object need persistence through other signals
        profile.save()
